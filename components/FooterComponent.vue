...
<template>
  <div>
    <div class="container-fluid footer py-5 wow " data-wow-delay="0.2s"
        style="background-color:#022452;min-height:230px;position: relative;z-index: 2;">
        <div class="container" style="max-width: 1004px;display: flex;justify-content: center;align-items: center;">
            <div class="row" style="width: 100%;">
                <div class=" col-md-6" style="display: flex;">
                    <img src="assets/images/concal/Logotipo vertical.png" alt="Logo" width="101px;" height="102px;">
                    <div style="">
                ...
                <div class=" col-md-6" style="display: flex;justify-content: end;">
                    <div style="justify-content: center;text-align: right;">
                        <div class="team-icon d-none d-xl-flex justify-content-center me-3"
                            style="display:flex !important;margin-right: 0px!important;justify-content: end !important;">
