...
<template>
  <div>
    ...
    <div style="min-height: 40px;background-color: #D9D9D9;display: flex;justify-content: center;">
            ...
            <p style="font-weight: 600;font-size: 14px;color: #022452;margin-bottom: 0px;padding-left: 16px;">INICIO <i class="fas fa-chevron-right" style="padding-left: 8px;padding-right: 8px;"></i> TRÁMITES Y SERVICIOS <i class="fas fa-chevron-right" style="padding-left: 8px;padding-right: 8px;"></i> RECOLECCIÓN DE BASURA</p>
            </div>
    </div>
            ...
            <div class="container" style="max-width: 1119px;z-index:2;position:relative;--bs-gutter-x: 5px;" >
                <div class="row">
                    <div class=" col-lg-9" style="padding-bottom: 10px;text-align: left;">
                           <p style="font-size: 48px;font-weight: 700;color:#022452;text-align: left;width: 90%;font-family: JostBold;">Recolección de basura</p>
                           <img src="assets/images/concal/imageAgua.png" class="d-block w-100" alt="..." style="padding-bottom: 30px;">
                           <h3>Requisitos Contrato de Recolección de Basura</h3>
                           <ul>
                            <li>Copia de la credencial de elector (INE)</li>
                            <li>Comprobante Domiciliario (vigencia no mayor a tres meses)</li>
                            <li>Copia de pago predial vigente</li>
                            <li>Cedula catastral del año en curso</li>
                             </ul>
