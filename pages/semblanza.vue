...
const { data, error } = await useAsyncData(async () => {
  try {
    ...
    const response = await $fetch('https://api.conkal.tobecorporativo.mx/api/v1/portal/pagina/listar', {
      method: 'GET',
      params: {
        page_categories_name: 'semblanza', // Agregar parámetros aquí en lugar de body
      },
      headers: {
      }
    })
...
<template>
  <div>
    ...
    <div style="min-height: 40px;background-color: #D9D9D9;display: flex;justify-content: center;">
            ...
            <p style="font-weight: 600;font-size: 14px;color: #022452;margin-bottom: 0px;padding-left: 16px;">INICIO <i class="fas fa-chevron-right" style="padding-left: 8px;padding-right: 8px;"></i> AYUNTAMIENTO <i class="fas fa-chevron-right" style="padding-left: 8px;padding-right: 8px;"></i> SEMBLANZA</p>
            </div>
    </div>
