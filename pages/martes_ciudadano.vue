...
<template>
  <div>
    ...
    <div style="min-height: 40px;background-color: #D9D9D9;display: flex;justify-content: center;">
            ...
            <p style="font-weight: 600;font-size: 14px;color: #022452;margin-bottom: 0px;padding-left: 16px;">INICIO <i class="fas fa-chevron-right" style="padding-left: 8px;padding-right: 8px;"></i> ATENCIÓN CIUDADANA<i class="fas fa-chevron-right" style="padding-left: 8px;padding-right: 8px;"></i> MARTES CIUDADANO</p>
            </div>
    </div>
                ...
                <div class="row">
                              ...
                              <template v-for="(post,index) in data">
                                <div class="col-sm-12  col-md-4  " data-wow-delay="0.2s" style="cursor: pointer;padding-top: 16px;">
                                  <a :href="'detalle_martes_ciudadano?id='+post.id">  <div class="blog-item" style="background-color: rgba(255, 255, 255, 0.5);border-radius: 8px;box-shadow: 0px 0px 20px 0px #00000059;">
                                                  ...
                                                  <div class="text-start"  style="height: 90px;background: #ffffff;position: relative;z-index: 10;border-radius: 0 0 10px 10px;">
                    ...
                    <div class="col-lg-3" style="padding-right: 0px !important;padding-left: 0px !important;" >
                          <div style="width: 100%;background-color: #065284;border-radius: 8px;margin-bottom: 30px;">
                            ...
                            <a href="reporte"><div class="contTitles" style="height: 40px;width: 100%;background-color: #D9D9D9;display: flex;justify-content: left;align-items: center;cursor: pointer;">
