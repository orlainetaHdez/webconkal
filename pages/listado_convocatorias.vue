...
<template>
  <div>
    ...
    <div style="min-height: 40px;background-color: #D9D9D9;display: flex;justify-content: center;">
            ...
            <p style="font-weight: 600;font-size: 14px;color: #022452;margin-bottom: 0px;padding-left: 16px;">INICIO <i class="fas fa-chevron-right" style="padding-left: 8px;padding-right: 8px;"></i> CONVOCATORIAS</p>
            </div>
    </div>
                ...
                <div class="row">
                    <div class=" col-lg-9" style="padding-bottom: 10px;text-align: left;">
                      <!-- <button style="border-color: transparent;padding: 10px;border-radius:8px;color:white;background-color:#1D95BA;font-size:16px;font-weight:700;" title="MÚSICA">Música</button>
                           ...
                           <p style="font-size: 48px;font-weight: 700;color:#022452;text-align: left;width: 90%;margin-bottom: 0px;font-family: JostBold;">Convocatorias</p>
