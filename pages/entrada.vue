            ...
            <div class="container" style="max-width: 1220px;" >
                ...
                <div class="row">
                    <div class=" col-lg-9" style="padding-bottom: 10px;text-align: left;">
                           <p style="font-size: 48px;font-weight: 700;color:#022452;text-align: left;width: 90%;margin-bottom: 0px;">Toma de protesta Administración 2024-2027</p>
                           <p style="font-size: 12px;font-weight: 700;color:#065284;text-align: left;">Viernes, 20 de septiembre de 2024</p>
                           <img src="assets/images/concal/slider/slider1.png" class="d-block w-100" alt="..." style="width: 820px;max-height: 400px;">
                           <div style="width: 100%;">
                             <p style="font-size: 12px;font-weight: 400;color: #595959;padding: 10px;background-color: #D9D9D9;">Nuestra #alcaldesa, Linda Pérez Quijano, rindió su toma de compromiso en una sesión solemne de Cabildo, donde reafirmó su compromiso de trabajo para que #Conkal se convierta en una ciudad más #unida, a través de un gobierno comprometido con la #juventud, el #desarrollo, la #igualdad, la #solidaridad, la #cultura, la #niñez y la #educación.</p>
                           </div>
